    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="clients"  to="/portal/clients">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1">Clients</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="timelogs"  to="/portal/timelogs">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Time Logs</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="event"  to="/portal/events">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Events</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="calendar"  to="/portal/calendar">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Calendar</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="projects"  to="/portal/projects">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Projects</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="tasks"  to="/portal/tasks">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Tasks</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="notes"  to="/portal/notes">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Notes</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
    ...
    <v-flex xs2
      ...
      <v-card class="clickable" @click.native="tags"  to="/portal/tags">
        ...
        <v-layout row>
          <v-flex xs12
                  text-xs-center>
            <h1 class="blue-grey--text lighten-1 ">Tags</h1>
          </v-flex>
        </v-layout>
      </v-card>
    </v-flex>
...
export default {
  ...
  created () {
    axios.get('/api/counters').then(response => {
      this.clientCounter = response.data.clientCounter
      this.eventCounter = response.data.eventCounter
      this.timelogCounter = response.data.timelogCounter
    }).catch(error => {
      console.log(error)
    })
  },
